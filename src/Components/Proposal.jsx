...
const Proposal = () => {
  ...
  return (
    <article className="relative ">
      ...
      <img className="mx-auto w-50 md:w-70" src={propose} alt="propose" />

      <h1 className="mb-5 mt-2 text-center font-['Pacifico',cursive] text-[clamp(1.9rem,5vw,2.7rem)] tracking-[0.02em] text-rose-700 drop-shadow-[0_4px_18px_rgba(222,31,89,0.2)]">
        Do You Love Me?
      </h1>
